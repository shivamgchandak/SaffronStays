                ...
                <div className={styles.leftInfo}>
                    ...
                    <div className={styles.ratingContainer}>
                        <div className={styles.rating}>
                            <span className={styles.ratingspan}><Image src="/star.png" alt="star" height={20} width={20}/> 4.5 <span>/ 5</span></span>
                    ...
                    <div className={styles.about}>
                        ...
                        <ul>
                            ...
                            <li>
                            The tourist-favourite Bhimtal Lake is only a throw away. <a href="#">Read more</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div className={styles.rightBooking}>
                    <div className={styles.priceBox}>
                        <div className={styles.priceRow}>
                            ...
                            <span className={styles.newPrice}>₹1,00,086</span><span className={styles.newPriceNight}>/Night</span>
                        </div>
